...
lint:  ## run static analysis with flake8
	python -m black --check forecast_weather setup.py
	python -m flake8 forecast_weather setup.py

# Alias
lints: lint

format:  ## run autoformatting with black
	python -m black forecast_weather/ setup.py
...
annotate:  ## run type checking
	python -m mypy ./forecast_weather
